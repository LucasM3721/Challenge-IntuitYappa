...
-- =============================================================
-- EXTENSIÓN PARA BÚSQUEDA SIN ACENTOS
-- =============================================================
CREATE EXTENSION IF NOT EXISTS unaccent;

-- =============================================================
-- STORED PROCEDURE: Search by Name (caracteres centrales)
-- =============================================================
CREATE OR REPLACE FUNCTION search_clientes_by_name(p_search_term VARCHAR)
RETURNS SETOF clientes AS $$
BEGIN
    RETURN QUERY 
    SELECT * FROM clientes 
    WHERE unaccent(nombre) ILIKE '%' || unaccent(p_search_term) || '%';
END;
$$ LANGUAGE plpgsql;
